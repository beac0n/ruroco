...
use ruroco::lib::{get_path, init_logger, time, SOCKET_FILE_PATH};
...
impl ServerState {
    fn create(pem_path: PathBuf, address: String, max_delay: u128) -> ServerState {
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    ServerState::create(pem_path, address, max_delay).run()
}
