...
(`keys/ruroco-release-ed25519.pub.pem`, private key is a CI secret) before touching disk; copy the
existing binary to `.old` (rollback snapshot), then atomically replace the target via
